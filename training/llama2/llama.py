...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='This script fine-tune the LLaMa2 with the PlantQA dataset.')
    parser.add_argument('-d','--data', help='Dataset directory', required=True)
